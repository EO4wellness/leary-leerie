...
* [My Course Notes](https://github.com/EO4wellness/leary-leerie/blob/master/READme-course-notes.txt)
* **CHALLENGE** add READme markdown files to every repository and project you create (past, present, and future tenses).
